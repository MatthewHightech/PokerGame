...
public class GameTemplate1 extends JPanel {
    ...
    static String [] cardName = {"D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D10", "D11", "D12", "D13",
   	...
   	static String[] hand1 = {"", "", "", "", ""}; //player 1's hand after update
    static String[] hand2 = {"", "", "", "", ""}; //player 2's hand after update 
	...
	private static class MouseListenerExample extends Frame implements MouseListener {
        ...
        public void mouseClicked(java.awt.event.MouseEvent ev) {
            ...
            if (gameStage == WELCOME_SCREEN) {
                ...
                if (x > 110 && x < 205 && y > 125 && y < 285) {
                    cardLocation[0] = 0;
                    backOrFront[0]++;
                    panel.repaint();
                } //if
				
                else if (x > 210 && x < 305 && y > 125 && y < 285) {
                    cardLocation[1] = 1;
                    backOrFront[1]++;
                    panel.repaint();
                } //else if
				
                else if (x > 310 && x < 405 && y > 125 && y < 285) {
                    cardLocation[2] = 2;
                    backOrFront[2]++;
                    panel.repaint();
                } //else if
				
                else if (x > 410 && x < 505 && y > 125 && y < 285) {
                    cardLocation[3] = 3;
                    backOrFront[3]++;
                    panel.repaint();
                } //else if
				
                else if (x > 510 && x < 605 && y > 125 && y < 285) {
                    cardLocation[4] = 4;
                    backOrFront[4]++;
                    panel.repaint();
                } //else if
                ...
                // detects when a key is pressed and sets the card location(for displaying the card Back image) and increments backOrFront (to determine if the card is face down or face up)
                if (x > 610 && x < 705 && y > 475 && y < 625) {
                    cardLocation[5] = 5;
                    backOrFront[5]++;
                    panel.repaint();
                } //if
				
                else if (x > 710 && x < 805 && y > 475 && y < 625) {
                    cardLocation[6] = 6;
                    backOrFront[6]++;
                    panel.repaint();
                } //else if
				
                else if (x > 810 && x < 905 && y > 475 && y < 625) {
                    cardLocation[7] = 7;
                    backOrFront[7]++;
                    panel.repaint();
                } //else if
				
                else if (x > 910 && x < 1005 && y > 475 && y < 625) {
                    cardLocation[8] = 8;
                    backOrFront[8]++;
                    panel.repaint();
                } //else if
				
                else if (x > 1010 && x < 1105 && y > 475 && y < 625) {
                    cardLocation[9] = 9;
                    backOrFront[9]++;
                    panel.repaint();
                } //else if
